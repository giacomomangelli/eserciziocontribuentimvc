	...
	<main role="main" class="container">
		...
		<div class='card'>
		    ...
		    <div class='card-body'>
					...
					<form:form method="post" modelAttribute="update_cartella_attr" action="modify" novalidate="novalidate" >
					
						<div class="form-row">
							<div class="form-group col-md-6">
								<label for="descrizione">Descrizione:</label>
								<spring:bind path="descrizione">
									<input type="text" name="descrizione" id="descrizione" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire la descrizione" value="${update_cartella_attr.descrizione }">
								</spring:bind>
							...
							<div class="form-group col-md-6">
								...
								<spring:bind path="importo">
									<input type="number" name="importo" id="importo" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire l'importo" value="${update_cartella_attr.importo }">
								</spring:bind>
				 		...
				 		<div class="form-group col-md-6">	
								<spring:bind path="statoCartella">
									<label for="statoCartella">Stato</label>
									    <select class="form-control" id="statoCartella" name="statoCartella">
							...
							<div class="form-group col-md-6">
								...
								<spring:bind path="contribuente.id">
									<input class="form-control ${status.error ? 'is-invalid' : ''}" type="text" id="contribuenteSearchInput"
										name="contribuenteId" value="${update_cartella_attr.contribuente.nome}${empty update_cartella_attr.contribuente.nome?'':' '}${update_cartella_attr.contribuente.cognome}">
								</spring:bind>
								<input type="hidden" name="contribuente.id" id="contribuenteId" value="${update_cartella_attr.contribuente.id }">
								<form:errors  path="contribuente.id" cssClass="error_field" />
							</div>
						</div>
						
						<input type = "hidden"	name = "id" id = "id" value = "${update_cartella_attr.id}" />						
